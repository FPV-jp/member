...
import { DesktopNavigationMenu, DesktopNavigationUserMenu, MobileNavigationMenu, MobileNavigationUserMenu, Button, IndigoButton, IconButton, MobileIconButton } from './DashboardMenu'
    ...
    <>
      ...
      <div className="min-h-full">
        <Disclosure as="nav" className="bg-gray-800">
          ...
          <MobileNavigation user={user} navigation={navigation} userNavigation={userNavigation} />
        </Disclosure>
...
/* eslint-disable react/prop-types */
function MobileNavigation({ user, navigation, userNavigation }) {
  return (
